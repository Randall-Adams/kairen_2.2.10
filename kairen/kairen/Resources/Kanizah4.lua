        ...
        if FAPI.IO.File_Exists(_FAPIDataFilePath) then
            ...
            while nl ~= nil do
                if nl ~= "" then
                    ...
                    elseif nl == "UpdatePlayerData" then
                        print("Kanizah.UpdatePlayerData()")
                        local NPCName = FAPI.IO.ReadNextLine(FDi, cs)
                        print("(" .. NPCName .. ")")
                        local NPCX = FAPI.IO.ReadNextLine(FDi, cs)
                        local NPCY = FAPI.IO.ReadNextLine(FDi, cs)
                        local NPCZ = FAPI.IO.ReadNextLine(FDi, cs)
                        local NPCF = FAPI.IO.ReadNextLine(FDi, cs)
                        local thisNPC
