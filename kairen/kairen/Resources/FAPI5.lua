...
if _G.FAPI.DirectoryLocation ~= nil then
    ...
    FAPI = {
        ...
        HelperFunctions = {
            ...
            HEX_DEC = dofile(FAPI.DirectoryLocation .. "Helper Functions/HEX_DEC.lua");
        };
    };
    EQOA = {
        UI = {
            ...
            Group = {
                NamePlate1 = FAPI.CE.Address.New("[pcsx2-r3878.exe+00402430]+888", "String", "GroupNamePlate1", "24", "1");
                NamePlate2 = FAPI.CE.Address.New("[pcsx2-r3878.exe+00402430]+8BC", "String", "GroupNamePlate2", "24", "1");
                NamePlate3 = FAPI.CE.Address.New("[pcsx2-r3878.exe+00402430]+8F0", "String", "GroupNamePlate3", "24", "1");
                NamePlate4 = FAPI.CE.Address.New("[pcsx2-r3878.exe+00402430]+924", "String", "GroupNamePlate4", "24", "1");
            };
        };
        Player = {
            Profile = {
                Name = FAPI.CE.Address.New("[pcsx2-r3878.exe+003FDCA0]+908", "String", "PlayerName", "24", "1");
                Class = {};
                Gender = {};
                Guild = {};
                Race = {};
            ...
            Location = {
                ...
                X2 = FAPI.CE.Address.New("[pcsx2-r3878.exe+0040239C]+6E0", "Float", "MyX");
                Y2 = FAPI.CE.Address.New("[pcsx2-r3878.exe+0040239C]+768", "Float", "MyY");
                Z2 = FAPI.CE.Address.New("[pcsx2-r3878.exe+0040239C]+6DC", "Float", "MyZ");
                Zone = (function()
                    local _rowcolumn
        ...
        HelperFunctions = {
            GetZoneRowColumn_ByCoords = (function(_eqoaXloc, _eqoaZloc)
                --returns column, then row.. name should be updated at some point.
