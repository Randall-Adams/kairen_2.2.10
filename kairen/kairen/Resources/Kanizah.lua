...
_G.Kanizah = {
    ...
    AddOutputByDefinition = (function(_definition)
        ...
        if _definition == "MyX" then
            _G.Kanizah.OutputArray[_G.Kanizah.CurrentIndex] = (function() return EQOA.Player.Location.X.Value(); end);
            _G.Kanizah.AdditionalDataArray[_G.Kanizah.CurrentIndex] = "MyX"
        elseif _definition == "MyY" then
            _G.Kanizah.OutputArray[_G.Kanizah.CurrentIndex] = (function() return EQOA.Player.Location.Y.Value(); end);
            _G.Kanizah.AdditionalDataArray[_G.Kanizah.CurrentIndex] = "MyY"
        elseif _definition == "MyZ" then
            _G.Kanizah.OutputArray[_G.Kanizah.CurrentIndex] = (function() return EQOA.Player.Location.Z.Value(); end);
            _G.Kanizah.AdditionalDataArray[_G.Kanizah.CurrentIndex] = "MyZ"
        elseif _definition == "MyF" then
            _G.Kanizah.OutputArray[_G.Kanizah.CurrentIndex] = (function() return EQOA.Player.Location.F.Value(); end);
            _G.Kanizah.AdditionalDataArray[_G.Kanizah.CurrentIndex] = "MyF"
        elseif _definition == "MyZone" then
