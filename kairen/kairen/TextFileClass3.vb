...
#Region "Functions"
    Public Sub SaveFile_old(Optional ByVal _newPath As String = Nothing)
    ...
    Private Function ChangeDataEntry(ByVal _additionalData As String, ByVal _newValue As String)
        ...
        Return -1
    End Function
    Public Function SaveFile(Optional ByVal _newFilePath As String = Nothing, Optional ByVal _newFileName As String = Nothing)
        ...
        Return 0
    End Function
    Public Function LoadFile(ByVal _filePath As String, ByVal _fileName As String)
    ...
    End Function
#End Region
    Public Sub RemoveTag(ByVal _tagToRemove As String)
        Dim i As Integer = 0
        Do Until i > vDataEntries.Count - 1 'match as #001
            If vDataEntries(i) Is Nothing Then
                Exit Do
            ElseIf vDataEntries(i).Name = _tagToRemove Then
                vDataEntries(i).RemoveData(_tagToRemove)
                Exit Sub
            End If
            i += 1
        Loop
